...
/* 
Usando a variável criada acima mostre no console o nome e o retorno da função atribuida a ela, com a seguinte frase:
...
- A função deve receber um parâmetro que dirá qual operação matemática ela vai efetuar. Será uma uma string com valores `+`, `-`, `*`, `/` ou `%`;
- Essa função deve retornar uma segunda função que fará o seguinte:
 - Essa segunda função deve receber dois parâmetros;
 - Esses dois parâmetros serão os operandos usados na opração matemática;
...
/* 
Agora declare algumas variáveis com os nomes "subtraction", "multiplication", "division" e "mode", e atribua a elas uma função "calculator", passando um operador correto por parâmetro para cada uma dela.
*/
